...
default_args = {
    ...
    'dataflow_default_options': {
        'project': 'qwiklabs-gcp-00-d7a6e30ed0cb',  #Add project-id
        'region': 'us-east1', #Add Composer region
...
with models.DAG('food_orders_dag',
    ...
    gcs_sensor = GoogleCloudStoragePrefixSensor(
        task_id='gcs_sensor',
        bucket='food-order-usd', #Add bucket name
        prefix='food_daily',
        mode='poke',
    ...
    beamtask = DataFlowPythonOperator(
        ...
        py_file='gs://us-east1-food-orders-dev-68f95164-bucket/beam.py',
        #Input file for the pipeline
        options={'input': 'gs://food-order-usd/{{ task_instance.xcom_pull("list_files") }}'}
    )
